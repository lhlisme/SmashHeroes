...
struct BaseDamageStatics
{
	...
	DECLARE_ATTRIBUTE_CAPTUREDEF(DefenseRange);
	DECLARE_ATTRIBUTE_CAPTUREDEF(StiffFactor);
	...
	BaseDamageStatics()
	{
		...
		DEFINE_ATTRIBUTE_CAPTUREDEF(UBaseAttributeSet, StiffFactor, Target, false);
